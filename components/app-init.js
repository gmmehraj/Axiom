...
(function () {
  ...
  function initCloudVoice(){ensureVoiceController(()=>{loadScriptOnce('os/runtime/capabilities/voice-adapter-kit.js',()=>{loadScriptOnce('js/core/elevenlabs-voice.js',()=>{loadScriptOnce('js/core/elevenlabs-scribe.js',()=>{loadScriptOnce('js/core/elevenlabs-voice-controller.js',()=>{loadScriptOnce('js/core/voice-website-controller.js',()=>{loadScriptOnce('js/core/voice-ui-bridge.js',()=>{loadScriptOnce('js/core/voice-user-greeting.js',()=>{if(window.AxiomVoiceGreeting)window.AxiomVoiceGreeting.init();});});});});});});});});}
